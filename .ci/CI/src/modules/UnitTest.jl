...
abstract type UnitTestType end

"""
Creates a unit test job which tests with a specific Julia version.

# Args

- `version::AbstractString`: Julia version.
"""
struct ReleaseVersion <: UnitTestType
    version::AbstractString
end

"""
Creates a unit test job which uses the latest Julia release candidate.
"""
struct ReleaseCandidate <: UnitTestType end
...
- `unit_test_type::UnitTestType`: Depending on the type, slightly different unit tests are generated.
